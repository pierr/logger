...
describe '#Test on the message property', ()->
  msgTxt = "Watch out!"
  context = {papa: "singe"}
  message = new Message('warn', msgTxt, context)
  ...
  it '## The toJSON method should be functionnal', ()->
    message.toJSON().should.be.deep.equals({"level": "warn", "message": msgTxt, "label": message.toString(), "date": message.date, "context": context })
